...
public class user_servlet extends HttpServlet
{
	...
	public void userReg(HttpServletRequest req,HttpServletResponse res)
	{
		...
		String del="no";
		String sql="insert into   t_user(loginname,loginpw,name,sex,age,address,tel,email,qq,del) values(?,?,?,?,?,?,?,?,?,?)";
		Object[] params={loginname,loginpw,name,sex,age,address,tel,email,qq,del};
		DB mydb=new DB();
