      ...
      href="../category/ShowAllProjectCategorys.action">项目管理</a></div></td>
                ...
                <table class="mars" cellspacing="1" cellpadding="0" width="100%" border="0">
                  <tbody>
                    ...
                    <s:iterator id="list" value="units" status="sta">
                    <tr bgcolor="#e4f1fe">
                      <td bgcolor="#f3f3f3"><div align="center"><s:property value="unit.unitid"/></div></td>
                      <td bgcolor="#f3f3f3"><div align="center"><s:property value="unit.unitname"/></div></td>
                      <td bgcolor="#f3f3f3"><div align="center"><s:property value="unit.address"/></div></td>
                      <td bgcolor="#f3f3f3"><div align="center"><s:property value="unit.corporation"/></div></td>
                      <td bgcolor="#f3f3f3"><div align="center"><s:property value="unit.investment"/></div></td>
                      <td bgcolor="#f3f3f3"><div align="center"><s:property value="unit.type"/></div></td>
                      <td bgcolor="#f3f3f3"><div align="center"><s:property value="unit.tel"/></div></td>
                      <td bgcolor="#f3f3f3"><div align="center"><s:property value="unit.introduction"/></div></td>
                      <td bgcolor="#f3f3f3"><div align="center"><a href="../unit/DisplayUpdateUnit.action?id=<s:property value="unit.unitid"/>">修改</a></div></td>
                      <td bgcolor="#f3f3f3"><div align="center"><a href="../unit/DeleteUnit.action?id=<s:property value="unit.unitid"/>">删除</a></div></td>
                    </tr>
                   </s:iterator>
                  </tbody>
                </table>
