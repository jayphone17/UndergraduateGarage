...
<div id="container" ><div id="content2"><table width="100%" height="41"  border="0" align="center" cellpadding="0" cellspacing="0"><tr><td width="15" height="18" align="left" valign="top"><div align="left"></div></td>
	  ...
	  <table cellspacing="0" cellpadding="0" width="100%" border="0">
	   <tbody><tr>
	                <td><div align="left">|&nbsp;&nbsp;欢迎管理员,<s:property value="user.username"/>&nbsp;&nbsp;|&nbsp;&nbsp;
                    ...
                    <td><div align="center"><a  href="./admin/ShowAllExperts.action">专家信息管理</a></div></td>
                    <td height="50"><div align="center"><a  href="./admin/ShowAllUnits.action">单位信息管理</a></div></td>
                    <td><div align="center"><a  href="./category/ShowAllProjectCategorys.action">项目管理</a></div></td>
              </tr>
	   </tbody>
	  </table>
