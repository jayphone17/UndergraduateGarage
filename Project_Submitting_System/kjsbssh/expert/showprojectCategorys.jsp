...
<div id="container" ><div id="content2"><table width="100%" height="41"  border="0" align="center" cellpadding="0" cellspacing="0"><tr><td width="15" height="18" align="left" valign="top"><div align="left"></div></td>
	  ...
	  <a href="javascript:history.go(-1)">后退</a>&nbsp;&nbsp;|</div></td>
                      <td><div align="center"><a  href="./expert/viewexpertinfo.html">专家信息</a></div></td>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                  <tbody>
                    <tr>
                      <td width="10%" align="center" valign="middle" bgcolor="#fba661">编号ID</td>
                      <td width="40%" align="center" valign="middle" bgcolor="#fba661">分类名称</td>
                      <td width="20%" align="center" valign="middle" bgcolor="#fba661">申报开始时间</td>
                      <td width="20%" align="center" valign="middle" bgcolor="#fba661">申报结束时间</td>
                      <td width="10%" align="center" valign="middle" bgcolor="#fba661">项目</td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td align="center" valign="middle" bgcolor="#f3f3f3"><a href="./expert/FindProjectInfo.action?id=categoryid">项目</a></td>
                    </tr>
                    </s:iterator>
                  </tbody>
                </table>
